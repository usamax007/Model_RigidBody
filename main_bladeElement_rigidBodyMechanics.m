...
wingkinsRawDataDirectory = "C:\Users\Usama\Dropbox (GaTech)\Research\Code\MatlabPlotApp\Data_WK";
...
saveVideo = false; % if you want to save the video of the 3D simulation
...
N = 1000; % number of time steps in a wingstroke
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bladeElement_rigidBodyMechanics([n N], useBodyMechanicsModel,morphDataDirectory,morphFileName,...
    wingkinsDataDirectory,wingkinsRawDataDirectory,wingKinsFileName,drawPlots,true,species_name,runTrimSearch,runVideoSimulation,saveVideo);
toc